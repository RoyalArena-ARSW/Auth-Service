...
public class GlobalExceptionHandler {
    ...
    /**
     * Errores de validación de @Valid en los DTOs (@NotBlank, @Email, @Size, etc.).
     ...
     * En producción NO expongas ex.getMessage() al cliente (revela detalles internos).
     * Aquí lo dejamos para desarrollo.
     */
